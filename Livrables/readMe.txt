...
Lancer le serveur RUST et l'exécutable .jar correspondant à l'application (test_et_securite_executable.jar)
...
- Installer Java (JDK 9.0.1) présent dans le dossier "Logiciels" 
- Lancer eclipse (exécutable présent dans le dossier "Logiciels") et / ou récupérer le .jar
